...
Its members include:
    + hap           : stores phased haplotypes (from .hap file)
...
/* init_I2 - Initialize an Impute2 object with genotype information from IMPUTE2 files
Arguments   : names of .hap file, .legend file, and .indv file
